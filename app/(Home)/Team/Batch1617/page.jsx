...
import { Batch1617 } from "@/constants";
  ...
  return (
    <section className="px-4 md:px-28 pt-[75px] w-full min-h-screen">
      ...
      <div className=" my-8 grid grid-cols-1 lg:grid-cols-3 gap-5">
        {Batch1617.map((Batch1617, index) => (
          <div
            key={Batch1617.position}
            ...
            <Image
              src={Batch1617.ImageUrl ? Batch1617.ImageUrl : placeholder}
              alt="Img"
              height={100}
              width={100}
