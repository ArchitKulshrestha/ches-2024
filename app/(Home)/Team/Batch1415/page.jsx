...
import { Batch1415 } from "@/constants";
  ...
  return (
    <section className="px-4 md:px-28 pt-[75px] w-full min-h-screen">
      ...
      <div className=" my-8 grid grid-cols-1 lg:grid-cols-3 gap-5">
        {Batch1415.map((Batch1415, index) => (
          <div
            key={Batch1415.position}
            ...
            <Image
              src={Batch1415.ImageUrl ? Batch1415.ImageUrl : placeholder}
              alt="Img"
              height={100}
              width={100}
