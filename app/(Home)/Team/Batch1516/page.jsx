...
import { Batch1516 } from "@/constants";
  ...
  return (
    <section className="px-4 md:px-28 pt-[75px] w-full min-h-screen">
      ...
      <div className=" my-8 grid grid-cols-1 lg:grid-cols-3 gap-5">
        {Batch1516.map((Batch1516, index) => (
          <div
            key={Batch1516.position}
            ...
            <Image
              src={Batch1516.ImageUrl ? Batch1516.ImageUrl : placeholder}
              alt="Img"
              height={100}
              width={100}
