...
import { Batch1819 } from "@/constants";
  ...
  return (
    <section className="px-4 md:px-28 pt-[75px] w-full min-h-screen">
      ...
      <div className=" my-8 grid grid-cols-1 lg:grid-cols-3 gap-5">
        {Batch1819.map((Batch1819, index) => (
          <div
            key={Batch1819.position}
            ...
            <Image
              src={Batch1819.ImageUrl ? Batch1819.ImageUrl : placeholder}
              alt="Img"
              height={100}
              width={100}
